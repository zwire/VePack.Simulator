...
//        public Onnx(string model, Provider provider, OptimizationLevel optimization)
//        {
...
//        public virtual IDictionary<string, float[]> Run(float[] inputData)
//        {
